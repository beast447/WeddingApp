    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 pt-20 pb-12 max-w-4xl mx-auto">
          ...
          >
            <span>Click to enter address and recieve a formal invite</span>
          </Link>
          <div>
            <Link
              to="https://www.myregistry.com/wedding-registry/stephanie-buckland-and-trevor-king-check-virginia/5341299/giftlist"
              className="inline-flex mt-5 items-center gap-2 px-8 py-4 bg-sage-600 hover:bg-sage-700 text-white font-medium rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            >
              <span>Visit our Wedding Registry</span>
            </Link>
          </div>
        </div>
      </section>
